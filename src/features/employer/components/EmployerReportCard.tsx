...
interface EmployerReportCardProps {
  report: AdminReport
  onExport: (id: string, title: string) => void
}

export function EmployerReportCard({ report, onExport }: EmployerReportCardProps) {
  return (
      ...
      <div className="flex justify-between items-start border-b border-border/30 pb-3 gap-2">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <Badge className="bg-orange-50 text-accent border-orange-200 hover:bg-orange-50 font-bold text-[10px] uppercase">
              {report.type}
            </Badge>
