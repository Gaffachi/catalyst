...
export default function MentorDashboardLayout({
  ...
  const sideNavSections = [
    {
      category: "Overview & Identity",
      items: [
        { name: "Overview", href: "/dashboard/mentor", icon: LayoutDashboard },
        { name: "Feed", href: "/dashboard/mentor/feed", icon: MessageSquare },
        { name: "Profile", href: "/dashboard/mentor/profile", icon: User },
      ]
    },
    {
      category: "Mentorship Work",
      items: [
        { name: "Students", href: "/dashboard/mentor/students", icon: Users },
        { name: "Sessions", href: "/dashboard/mentor/sessions", icon: CalendarClock },
        { name: "Availability", href: "/dashboard/mentor/availability", icon: Clock },
      ]
    },
    {
      category: "Reviews & Assessment",
      items: [
        { name: "Portfolio Reviews", href: "/dashboard/mentor/portfolio-reviews", icon: FolderCheck },
        { name: "Career Assessments", href: "/dashboard/mentor/career-assessments", icon: ClipboardCheck },
      ]
    },
    {
      category: "Insights & Communication",
      items: [
        { name: "Analytics", href: "/dashboard/mentor/analytics", icon: TrendingUp },
        { name: "Reports", href: "/dashboard/mentor/reports", icon: BarChart3 },
        { name: "Messages", href: "/dashboard/mentor/messages", icon: MessageSquare },
        { name: "Notifications", href: "/dashboard/mentor/notifications", icon: Bell },
      ]
    },
    {
      category: "Account",
  ...
  return (
    <AuthGuard>
      <div className="flex-grow flex flex-col md:flex-row min-h-screen bg-slate-50 dark:bg-slate-950/20">
        ...
        <header className="md:hidden sticky top-0 z-40 w-full border-b border-border/40 bg-white/80 backdrop-blur-md flex items-center justify-between px-4 h-14 select-none">
          <div className="flex items-center gap-2 font-heading font-extrabold text-foreground">
            ...
            <span className="text-sm">Mentor Console</span>
          </div>
        ...
        {/* 3. Main Dashboard Workspace Content Section */}
