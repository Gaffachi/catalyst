  ...
  const sideNavSections = [
    {
      ...
      items: [
        ...
        { name: "Feed", href: "/dashboard/student/feed", icon: MessageSquare },
        { name: "Career Profile", href: "/dashboard/student/profile", icon: User },
        { name: "Skills Development", href: "/dashboard/student/skills", icon: Sparkles },
      ]
    },
    {
      category: "Work & Verification",
      items: [
        { name: "Portfolio", href: "/dashboard/student/portfolio", icon: FolderGit },
        { name: "Assessments", href: "/dashboard/student/assessments", icon: ClipboardCheck },
        { name: "Progress Report", href: "/dashboard/student/reports", icon: BarChart3 },
      ]
    },
    {
      category: "Opportunities",
      items: [
        { name: "Marketplace", href: "/dashboard/student/marketplace", icon: Briefcase },
        { name: "Companies", href: "/dashboard/student/employers", icon: Building2 },
        { name: "Applications", href: "/dashboard/student/applications", icon: ListTodo },
        { name: "Interviews", href: "/dashboard/student/interviews", icon: CalendarClock },
      ]
    },
    {
      category: "Mentorship",
      items: [
        { name: "Mentorship Hub", href: "/dashboard/student/mentorship", icon: GraduationCap },
        { name: "Sessions", href: "/dashboard/student/sessions", icon: CalendarClock },
          ...
          <div className="md:hidden fixed inset-x-0 top-14 bottom-0 z-30 bg-background/95 backdrop-blur-sm p-4 space-y-6 flex flex-col justify-between animate-in fade-in duration-200 select-none overflow-y-auto">
            ...
            <div className="pt-4 border-t border-border/40 pb-6 shrink-0">
              <Button
                ...
                variant="ghost"
                className="w-full justify-center rounded-xl text-xs font-bold text-destructive hover:bg-rose-50"
              >
